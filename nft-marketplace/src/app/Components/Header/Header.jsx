...
export default function Header() {
  return (
    <div className='my-28 mx-96 grid grid-cols-2 max-2xl:grid-cols-1 max-2xl:mx-20'>
        <div className='flex justify-center flex-col'>
            <h1 className='font-mono text-[50px]'>Discover <br /> digital art & <br /> Collect NFTs</h1>
<p className='text-[25px] leading-12 font-mono my-5 '>NFT marketplace UI created with Anima for Figma. Collect, buy and sell art from more than 20k NFT artists.</p>

<div className='grid grid-cols-2 my-8'>
  <button className='bg-bgBtn flex justify-center py-5 rounded-2xl items-center'>
  <svg className='bg-bgBtn mr-2' width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div className='grid grid-cols-3 mt-8 text-[20px] font-mono'>
    <span>240K+</span>
    <span>100K</span>
    <span>240K+</span>
