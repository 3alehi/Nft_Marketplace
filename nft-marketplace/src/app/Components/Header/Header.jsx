  ...
  return (
    <div className='my-28 mx-80 grid grid-cols-2 max-md:grid-cols-1 max-2xl:mx-16 max-xl:mx-10 max-md:my-20'>
      <div className='flex justify-center flex-col'>
        ...
        <div className='grid grid-cols-3 mt-8 text-[20px] font-mono max-md:text-center'>
          <span>240K+</span>
          <span>100K</span>
          <span>240K+</span>
          <span className='max-sm:text-[15px]'>Total Sale</span>
          <span className='max-sm:text-[15px]'>Auctions</span>
          <span className='max-sm:text-[15px]'>Artists</span>
