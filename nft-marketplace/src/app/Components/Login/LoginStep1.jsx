...
export default function LoginStep1({handelLoginModal }) {
  ...
  return (
    ...
    <div class="p-8 px-9 rounded-lg shadow-lg">
    <i className=' cursor-pointer w-full flex justify-end ' onClick={handelLoginModal}>
            ...
            <h1 className='text-[20px] font-mono my-5'>Welcom To Nft MarketPlace</h1>
            <input type="text" placeholder='enter email to for login' className='border border-[#363535a8] outline-none p-5' />
